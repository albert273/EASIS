...
const data = [
  {
    ...
    icon: <BusinessIcon sx={{ color: "#FF7E43", fontSize: "2.2rem" }} />,
  },
  {
    id: 2,
    ...
    icon: (
      <CorporateFareSharpIcon sx={{ color: "#FF7E43", fontSize: "2.2rem" }} />
    ),
  },
  {
    id: 3,
    ...
    icon: <ApartmentSharpIcon sx={{ color: "#FF7E43", fontSize: "2.2rem" }} />,
  },
];
