...
function Hero2() {
  ...
  return (
    <Box>
      ...
      <Stack sx={{ height: "75vh", width: "100%", bgcolor: "#283593", }} alignItems={'center'}>
        <Stack gap={3} ref={sectionRef} justifyContent={"center"} sx={{marginTop: "140px"}}>
          <Box
            sx={{
              padding: "8px 12px",
              backgroundColor: "#e8eaf62e",
          ...
          <Stack direction={"row"} gap={2} ref={bottomRef} sx={{              marginX: "auto"
}}>
            <Link href={"/MakeQuote"}>
              <Button
                variant="contained"
